...
public class ReportService : IReportService
{
    ...
    public async Task<DailyReportDto> GenerateDailyReportAsync(DateTime? closingTime = null)
    {
        ...
        var poolStatus = await _poolService.GetStatusAsync();
        var maxOccupancy = poolStatus.MaxCapacity; // TODO: Calcular máximo real do dia
        ...
        var todayCleanings = cleanings.Where(c => c.CleanedAt.Date == today).ToList();
