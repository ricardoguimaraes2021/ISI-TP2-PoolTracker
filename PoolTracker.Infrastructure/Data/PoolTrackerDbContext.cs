...
public class PoolTrackerDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DailyReport>(entity =>
        {
            ...
            entity.Property(e => e.WaterQualityChildren).HasColumnType("nvarchar(max)");
            entity.Property(e => e.WaterQualityAdults).HasColumnType("nvarchar(max)");
            entity.Property(e => e.ActiveWorkersCount).HasColumnType("nvarchar(max)");
            entity.Property(e => e.CleaningRecords).HasColumnType("nvarchar(max)");
