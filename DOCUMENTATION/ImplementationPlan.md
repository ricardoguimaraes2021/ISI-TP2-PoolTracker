...
- [x] **Publicou Repositório de Dados na Cloud** - ✅ Azure SQL Database (Free tier)
- [x] **Explorou aplicação de segurança nos serviços (OAuth/JWT)** - JWT Bearer Authentication
- [x] **Publicou Serviços na Cloud** - ✅ Azure App Service (pooltracker-api-64853)
...
- [ ] Deploy do frontend (pendente - pode usar Vercel/Netlify)
...
- SOAP Services: https://pooltracker-api-64853.azurewebsites.net/soap/{ServiceName}?wsdl
...
**Documentação criada**:
- `DOCUMENTATION/DEPLOY_AZURE.md`: Guia completo de deploy na Azure
- `DOCUMENTATION/DEPLOY_SOAP.md`: Guia de deploy dos serviços SOAP
- `DOCUMENTATION/SOAP_SERVICES.md`: Documentação completa dos serviços SOAP
- `DOCUMENTATION/Relatorio_TP2.md`: Relatório académico completo
- `README.md`: Atualizado com estado atual do projeto (Todas as fases completas)
...
| Fase 9: Deploy na Cloud | 6-8h | ✅ Concluída |
...
| **Repositório na Cloud** | ✅ Azure SQL Database (Free tier) - pooltracker-sql-65033 |
| **Segurança** | JWT Bearer Authentication (Fase 4) |
| **Serviços na Cloud** | ✅ Azure App Service (pooltracker-api-64853) |
